...
<div class="x-body">
    <div class="tools">
        ${tip_info}
        <ul class="toolbar">
            <li onclick="deleteByIds()"><span><img src="${pageContext.request.contextPath}/images/t03.png"/></span>批量删除
            </li>
            <li onclick="user_management_add('添加学院信息','add_page','600','500')">
        ...
        <c:forEach items="${academy_list}" var="academy" varStatus="i">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="编辑" href="#"
                       onclick="user_management_edit('修改学院信息','update_page?id=${academy.id}','600','500')"
